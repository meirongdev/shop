...
public interface LoyaltyServiceClient {
    ...
    ApiResponse<LoyaltyApi.AccountResponse> getAccount(
    ...
    ApiResponse<LoyaltyApi.TransactionResponse> deductPoints(
            @RequestBody LoyaltyApi.DeductPointsRequest request);

    @PostExchange(LoyaltyApi.INTERNAL_EARN)
    ApiResponse<LoyaltyApi.TransactionResponse> earnPoints(
            @RequestBody LoyaltyApi.EarnPointsRequest request);
}
