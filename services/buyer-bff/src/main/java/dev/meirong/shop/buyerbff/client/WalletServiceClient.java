...
public interface WalletServiceClient {
    ...
    ApiResponse<WalletApi.TransactionResponse> deposit(
            @RequestBody WalletApi.DepositRequest request);
    ...
    ApiResponse<WalletApi.PaymentIntentResponse> createPaymentIntent(
            @RequestBody WalletApi.CreatePaymentIntentRequest request);

    @PostExchange(WalletApi.PAYMENT_CREATE)
    ApiResponse<WalletApi.TransactionResponse> createPayment(
            @RequestBody WalletApi.CreatePaymentRequest request);

    @PostExchange(WalletApi.PAYMENT_REFUND)
    ApiResponse<WalletApi.TransactionResponse> createRefund(
            @RequestBody WalletApi.CreateRefundRequest request);
}
