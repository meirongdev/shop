package dev.meirong.shop.promotion.config;
...
public class PromotionIdempotencyConfiguration {
    ...
    IdempotencyGuard promotionDbIdempotencyGuard(PromotionIdempotencyKeyRepository idempotencyRepository) {
    ...
    IdempotencyGuard promotionRedisIdempotencyGuard(RedissonClient redissonClient,
