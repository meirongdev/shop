package dev.meirong.shop.clients.order;
...
public interface OrderServiceClient {
    ...
    ApiResponse<OrderApi.CartItemResponse> updateCart(@RequestBody OrderApi.UpdateCartRequest request);

    @PostExchange(OrderApi.CART_REMOVE)
    ApiResponse<Void> removeFromCart(@RequestBody OrderApi.RemoveFromCartRequest request);

    @PostExchange(OrderApi.CART_CLEAR)
    ApiResponse<Void> clearCart(@RequestBody OrderApi.ClearCartRequest request);

    @PostExchange(OrderApi.CHECKOUT_CREATE)
    ApiResponse<OrderApi.OrderResponse> createOrder(@RequestBody OrderApi.CreateOrderRequest request);

    @PostExchange(OrderApi.GUEST_CHECKOUT)
    ApiResponse<OrderApi.OrderResponse> guestCheckout(@RequestBody OrderApi.GuestCheckoutRequest request);
    ...
    ApiResponse<List<OrderApi.OrderResponse>> listOrders(@RequestBody OrderApi.ListOrdersRequest request);
    ...
    ApiResponse<OrderApi.OrderResponse> cancelOrder(@RequestBody OrderApi.CancelOrderRequest request);

    // ── Seller-facing endpoints ──

    @PostExchange(OrderApi.ORDER_SHIP)
    ApiResponse<OrderApi.OrderResponse> shipOrder(@RequestBody OrderApi.ShipOrderRequest request);

    @PostExchange(OrderApi.ORDER_DELIVER)
    ApiResponse<OrderApi.OrderResponse> deliverOrder(@RequestBody OrderApi.ConfirmOrderRequest request);
}
